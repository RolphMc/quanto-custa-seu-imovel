...
class SpinnerConfig{
    ...
    companion object {
        ...
        const val DEFAULT_SPINNER_TITLE_SIZE_PX = 32f
        const val DEFAULT_TOUCH_OUTSIDE_CANCELED = true
        const val DEFAULT_LINE_SCALE = 0.3f
        val DEFAULT_FOOTER_MODE = SpinnerMode.MODE_EXPAND
        ...
        const val DEFAULT_SPINNER_UNIT_TEXT_MARGIN_LEFT = 10f
        const val DEFAULT_SPINNER_DATE_FOOTER_HINT = "请选择..."
