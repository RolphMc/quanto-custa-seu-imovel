...
import com.sugarya.footer.adapter.LinearSpinnerAdapter
import com.sugarya.footer.base.BaseSpinnerSpinner
import com.sugarya.footer.interfaces.FooterMode
import com.sugarya.footer.interfaces.ISpinnerItem
import com.sugarya.footer.interfaces.OnSpinnerItemClickListener
 ...
 */
class SpinnerLinearSpinner : BaseSpinnerSpinner<LinearFooterProperty> {
    ...
    var mOnSpinnerItemClickListener: OnSpinnerItemClickListener? = null
    private var mAdapter: LinearSpinnerAdapter? = null
    ...
    private fun init(context: Context) {
        ...
        mAdapter = LinearSpinnerAdapter(baseFooterViewProperty.linearItemHeight, recyclerView)
        recyclerView.adapter = mAdapter
        mAdapter?.mOnSpinnerItemContainerClickListener = object : OnSpinnerItemContainerClickListener {
            override fun onItemClick(list: MutableList<ISpinnerItem>, position: Int) {
                for (item in list) {
                ...
                mOnSpinnerItemClickListener?.onClick(list[position])
            }
        }
    }
...
//        filterBarLayout.bringToFront()
    ...
    fun setOnFooterItemClickListener(onSpinnerItemClickListener: OnSpinnerItemClickListener) {
