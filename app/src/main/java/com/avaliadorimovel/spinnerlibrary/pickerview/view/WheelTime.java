package com.avaliadorimovel.spinnerlibrary.pickerview.view;

import android.view.View;

import com.sugarya.pickerview.adapter.ArrayWheelAdapter;
import com.sugarya.pickerview.adapter.NumericWheelAdapter;
import com.sugarya.pickerview.contrarywind.listener.OnItemSelectedListener;
import com.sugarya.pickerview.contrarywind.view.WheelView;
import com.sugarya.pickerview.listener.ISelectTimeCallback;
import com.sugarya.pickerview.utils.ChinaDate;
import com.sugarya.pickerview.utils.LunarCalendar;
...
public class WheelTime {
    ...
    private void setLunar(int year, final int month, int day, boolean isLeap, int h, int m, int s) {
        // 年
        wv_year = (WheelView) view.findViewById(R.id.spinnerYear);
        ...
        // 月
        wv_month = (WheelView) view.findViewById(R.id.spinnerMonth);
        ...
        // 日
        wv_day = (WheelView) view.findViewById(R.id.spinnerDay);
        ...
        wv_hours = (WheelView) view.findViewById(R.id.spinnerHour);
        wv_hours.setAdapter(new NumericWheelAdapter(0, 23));
        //wv_hours.setLabel(context.getString(R.string.pickerview_hours));// 添加文字
        wv_hours.setCurrentItem(h);
        wv_hours.setGravity(gravity);

        wv_minutes = (WheelView) view.findViewById(R.id.spinnerMin);
        ...
        wv_seconds = (WheelView) view.findViewById(R.id.spinnerSecond);
